...
import * as RovingFocusGroup from "./utils-roving-focus-group";
import { createRovingFocusGroupScope } from "./utils-roving-focus-group";
      ...
      >
        <Primitive.button
          ...
          onMouseDown={composeEventHandlers(props.onMouseDown, (event) => {
            // Empêcher le comportement par défaut pour éviter de voler le focus
