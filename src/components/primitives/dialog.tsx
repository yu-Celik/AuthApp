...
import { createContext, createContextScope, type Scope } from "./utils-context";
import { DismissableLayer } from "./utils-dismissable-layer";
import { FocusScope } from "./utils-focus-scope";
...
>((props: ScopedProps<DialogContentImplProps>, forwardedRef) => {
  const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } =
    props;
...
>((props: ScopedProps<DialogDescriptionProps>, forwardedRef) => {
  ...
  return (
    <Primitive.p id={context.descriptionId} {...descriptionProps} ref={forwardedRef} />
  );
});
